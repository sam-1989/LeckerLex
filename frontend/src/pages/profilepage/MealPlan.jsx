...
// // Hilfsfunktion, um das heutige Datum und die nächsten 6 Tage zu berechnen
// const getWeekDays = () => {
//   const days = [];
...
// export default function MealPlan() {
//   const [weekDays, setWeekDays] = useState(getWeekDays()); // Dynamisch berechnete Woche
//   const [selectedDate, setSelectedDate] = useState(
//     new Date().toISOString().split("T")[0] // Standard: heutiges Datum
//   );
//   const [mealData, setMealData] = useState(
...
//   useEffect(() => {
//     // Aktualisiert die Woche dynamisch, falls nötig
...
// export default function MealPlan() {
//   const [selectedDate, setSelectedDate] = useState("24"); // Default to Sunday
//   const [mealData, setMealData] = useState(
//     daysOfWeek.reduce((acc, day) => {
//       acc[day.date] = { ...initialMeals };
//       return acc;
//     }, {})
//   );
//   const [showAddMeal, setShowAddMeal] = useState(false);

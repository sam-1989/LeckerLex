  ...
  return (
    <div className="p-4 max-w-6xl mx-auto relative">
      ...
      <div className="relative mx-auto w-full sm:w-8/12 lg:w-6/12 h-52 sm:h-64 lg:h-80 mt-16">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black bg-opacity-40 px-4 py-1 rounded-3xl"
          style={{
            maxWidth: "80%",
          }}
        >
      ...
      <div className="mt-6 mx-4 sm:mx-8 lg:mx-10 flex flex-wrap justify-center sm:justify-around gap-4">
        <button
          className="px-4 py-2 w-full sm:w-auto bg-green-500 text-white hover:text-gray-800 rounded-3xl shadow-md text-sm sm:text-base"

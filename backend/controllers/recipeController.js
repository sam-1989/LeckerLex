...
export const searchRecipesAndDetails = async (req, res, next) => {
  ...
  try {
    ...
    const response = await fetch(
      `https://api.spoonacular.com/recipes/findByIngredients?ingredients=salt,water,oil,sugar,${ingredients}&ranking=2&ignorePantry=true&number=16`, // TODO eg. number=5, how many recipes to fetch
      options
    );
